        ...
        evolutions: [
          {
            ...
            description: 'Turno programado — control evolutivo de úlcera sacra.',
            procedure: 'Limpieza con solución fisiológica. Reevaluación de tejido. Apósito de espuma.',
            materials: 'Solución fisiológica, apósito de espuma multicapa Mepilex Border, gasas estériles',
            healingFrequency: 'Cada 48hs', healingFrequencyDays: 2,
            observations: 'Mantener cambios posturales cada 2hs.',
            nextControl: '2026-05-05',
            painLevel: 4, odor: 'leve', evolutionStatus: 'mejoria_progresiva',
            woundLength: 6.5, woundWidth: 5, woundDepth: 0.8,
          ...
          },
          {
            ...
            professional: 'Lic. María González',
            description: 'Turno programado — curación intermedia.',
            procedure: 'Limpieza, desbridamiento autolítico residual y apósito de espuma.',
            materials: 'Solución fisiológica, hidrogel amorfo, apósito de espuma Mepilex Border',
            healingFrequency: 'Cada 48hs', healingFrequencyDays: 2,
            observations: 'Lecho con buena perfusión. Continuar protocolo.',
            nextControl: '2026-05-03',
            painLevel: 4, odor: 'leve', evolutionStatus: 'mejoria_progresiva',
            woundLength: 7, woundWidth: 5.2, woundDepth: 0.9,
          ...
          },
          {
            ...
            professional: 'Lic. María González',
            description: 'Turno programado — curación de control.',
            procedure: 'Limpieza con solución fisiológica. Apósito de espuma multicapa.',
            materials: 'Solución fisiológica, apósito de espuma Mepilex Border, gasas estériles',
            healingFrequency: 'Cada 48hs', healingFrequencyDays: 2,
            observations: 'Sin cambios desfavorables. Mantener tratamiento.',
            nextControl: '2026-04-30',
            painLevel: 4, odor: 'leve', evolutionStatus: 'mejoria_progresiva',
            woundLength: 7.2, woundWidth: 5.4, woundDepth: 1.0,
            tissueTypes: ['granulacion', 'fibrina'],
            edgeTypes: ['regular', 'macerado'],
            exudateAmount: 'moderado', exudateType: 'seroso', exudateColor: 'amarillo',
            hasInfectionSigns: false, bodyTemperature: 36.6,
        ...
        evolutions: [
          {
            ...
            time: '11:00',
            professional: 'Dr. Carlos Rodríguez',
            description: 'Turno programado — control de pie diabético.',
            procedure: 'Limpieza con SF. Aplicación de cadexómero iodado. Apósito no adherente.',
            materials: 'Cadexómero iodado (Iodosorb), apósito no adherente Mepitel, venda de fijación',
            healingFrequency: 'Cada 72hs', healingFrequencyDays: 3,
            observations: 'Continuar descarga con bota Walker.',
            nextControl: '2026-05-04',
            painLevel: 2, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 2.4, woundWidth: 1.9, woundDepth: 0.4,
            tissueTypes: ['granulacion', 'epitelizacion'],
            edgeTypes: ['regular'],
          ...
          },
          {
            ...
            time: '11:00',
            professional: 'Dr. Carlos Rodríguez',
            description: 'Turno programado — curación de pie diabético.',
            procedure: 'Curación con cadexómero iodado y apósito no adherente.',
            materials: 'Cadexómero iodado (Iodosorb), apósito no adherente Mepitel, venda de fijación',
            healingFrequency: 'Cada 72hs', healingFrequencyDays: 3,
            observations: 'Buen control glucémico. Adherencia óptima.',
            nextControl: '2026-05-01',
            painLevel: 3, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 2.6, woundWidth: 2.0, woundDepth: 0.5,
            tissueTypes: ['granulacion', 'epitelizacion'],
            edgeTypes: ['regular'],
            exudateAmount: 'escaso', exudateType: 'seroso', exudateColor: 'transparente',
            hasInfectionSigns: false, bodyTemperature: 36.6,
        ...
        evolutions: [
          {
            ...
            description: 'Turno programado — control de úlcera venosa.',
            procedure: 'Limpieza con SF. Apósito de alginato con plata. Vendaje compresivo multicapa.',
            materials: 'Hidrofibra Aquacel Ag+, alginato con plata, vendaje compresivo Profore',
            healingFrequency: 'Cada 48hs', healingFrequencyDays: 2,
            observations: 'Mantener elevación de MMII y compresión continua.',
            nextControl: '2026-05-10',
            painLevel: 5, odor: 'leve', evolutionStatus: 'mejoria_progresiva',
            woundLength: 10, woundWidth: 6.5, woundDepth: 0.4,
            tissueTypes: ['granulacion', 'fibrina'],
            edgeTypes: ['regular', 'eritematoso'],
            exudateAmount: 'moderado', exudateType: 'seroso', exudateColor: 'amarillo',
            hasInfectionSigns: false, bodyTemperature: 36.8,
            photos: [],
          },
          {
            id: 'e5-t2',
            ...
            professional: 'Lic. Ana Martínez',
            description: 'Turno programado — curación intermedia.',
            procedure: 'Desbridamiento con hidrofibra. Apósito de alginato con plata. Vendaje compresivo.',
            materials: 'Hidrofibra Aquacel Ag+, alginato con plata, vendaje Profore, protector cutáneo',
            healingFrequency: 'Cada 48hs', healingFrequencyDays: 2,
            observations: 'Continuar plan compresivo. Reevaluar dolor.',
            nextControl: '2026-05-04',
            painLevel: 6, odor: 'moderado', evolutionStatus: 'tratamiento_activo',
            woundLength: 11, woundWidth: 7, woundDepth: 0.5,
            tissueTypes: ['granulacion', 'fibrina'],
            edgeTypes: ['irregular', 'macerado'],
            exudateAmount: 'moderado', exudateType: 'serosanguinolento', exudateColor: 'amarillo',
            hasInfectionSigns: false, bodyTemperature: 37.0,
            photos: [],
          },
          {
            id: 'e5-t1',
            ...
            time: '14:30',
            professional: 'Lic. Ana Martínez',
            description: 'Turno programado — curación con compresión.',
            procedure: 'Limpieza, desbridamiento y vendaje compresivo multicapa.',
            materials: 'Hidrofibra Aquacel Ag+, alginato con plata, vendaje Profore',
            healingFrequency: 'Cada 48hs', healingFrequencyDays: 2,
            observations: 'Persisten signos de inflamación perilesional leve.',
            nextControl: '2026-04-27',
            painLevel: 6, odor: 'moderado', evolutionStatus: 'tratamiento_activo',
            woundLength: 11.5, woundWidth: 7.5, woundDepth: 0.5,
            tissueTypes: ['fibrina', 'esfacelo'],
            edgeTypes: ['irregular', 'macerado', 'eritematoso'],
            exudateAmount: 'abundante', exudateType: 'serosanguinolento', exudateColor: 'rojo',
            hasInfectionSigns: true, infMalOlor: true, infEritema: true,
            bodyTemperature: 37.2,
            photos: [],
          },
          {
        ...
        evolutions: [
          {
            ...
            description: 'Turno programado — control de herida quirúrgica.',
            procedure: 'Irrigación con PHMB. Packing con gasa húmeda. Apósito absorbente.',
            materials: 'PHMB (Prontosan), gasas húmedas estériles, apósito absorbente, cinta hipoalergénica',
            healingFrequency: 'Diaria', healingFrequencyDays: 1,
            observations: 'Reevaluar VAC therapy según evolución.',
            nextControl: '2026-05-10',
            painLevel: 4, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 12, woundWidth: 3, woundDepth: 1.5,
            tissueTypes: ['granulacion', 'epitelizacion'],
            edgeTypes: ['regular'],
            exudateAmount: 'escaso', exudateType: 'seroso', exudateColor: 'amarillo',
            hasInfectionSigns: false, bodyTemperature: 36.7,
          ...
          },
          {
            ...
            time: '16:00',
            professional: 'Dr. Roberto Sánchez',
            description: 'Turno programado — curación diaria.',
            procedure: 'Irrigación con PHMB y packing con gasa húmeda. Apósito secundario.',
            materials: 'PHMB (Prontosan), gasas húmedas, apósito absorbente, cinta hipoalergénica',
            healingFrequency: 'Diaria', healingFrequencyDays: 1,
            observations: 'Sin signos floridos de infección. Continuar protocolo.',
            nextControl: '2026-05-05',
            painLevel: 5, odor: 'leve', evolutionStatus: 'mejoria_progresiva',
            woundLength: 13, woundWidth: 3.2, woundDepth: 1.8,
            tissueTypes: ['granulacion', 'fibrina'],
            edgeTypes: ['irregular'],
            exudateAmount: 'moderado', exudateType: 'seroso', exudateColor: 'amarillo',
            hasInfectionSigns: false, bodyTemperature: 36.9,
            photos: [],
          },
          {
            id: 'e6-t1',
            ...
            time: '16:00',
            professional: 'Dr. Roberto Sánchez',
            description: 'Turno programado — control post-ATB.',
            procedure: 'Irrigación con PHMB. Packing y apósito absorbente.',
            materials: 'PHMB (Prontosan), gasas húmedas, apósito absorbente, cinta hipoalergénica',
            healingFrequency: 'Diaria', healingFrequencyDays: 1,
            observations: 'Tras ATB persiste leve eritema. Tomar nuevo cultivo si empeora.',
            nextControl: '2026-04-30',
            painLevel: 5, odor: 'leve', evolutionStatus: 'tratamiento_activo',
            woundLength: 13.5, woundWidth: 3.4, woundDepth: 2.0,
            tissueTypes: ['granulacion', 'fibrina'],
            edgeTypes: ['irregular', 'eritematoso'],
            exudateAmount: 'moderado', exudateType: 'purulento', exudateColor: 'amarillo',
            hasInfectionSigns: true, infEritema: true,
        ...
        evolutions: [
          {
            ...
            description: 'Turno programado — control de quemadura.',
            procedure: 'Limpieza suave. Crema hidratante con aloe vera. Apósito de silicona.',
            materials: 'Solución fisiológica, crema hidratante con aloe vera, apósito de silicona Mepiform, protector solar SPF50',
            healingFrequency: 'Cada 72hs', healingFrequencyDays: 3,
            observations: 'Continuar prevención de cicatriz hipertrófica.',
            nextControl: '2026-05-09',
            painLevel: 2, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 4, woundWidth: 3, woundDepth: 0.0,
            tissueTypes: ['epitelizacion'],
            edgeTypes: ['regular'],
            exudateAmount: 'sin_exudado', exudateType: 'seroso', exudateColor: 'transparente',
            hasInfectionSigns: false, bodyTemperature: 36.5,
            photos: [],
          },
          {
            ...
            time: '09:00',
            professional: 'Lic. Laura Fernández',
            description: 'Turno programado — curación post-quemadura.',
            procedure: 'Limpieza con SF. Aplicación de hidratante y apósito de silicona.',
            materials: 'Solución fisiológica, crema hidratante, apósito de silicona Mepiform',
            healingFrequency: 'Cada 72hs', healingFrequencyDays: 3,
            observations: 'Reepitelización avanzada. Sin signos de infección.',
            nextControl: '2026-05-05',
            painLevel: 3, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 5, woundWidth: 3.5, woundDepth: 0.05,
            tissueTypes: ['epitelizacion', 'granulacion'],
            edgeTypes: ['regular'],
            exudateAmount: 'escaso', exudateType: 'seroso', exudateColor: 'transparente',
            hasInfectionSigns: false, bodyTemperature: 36.5,
          ...
          },
          {
            ...
            professional: 'Lic. Laura Fernández',
            description: 'Turno programado — control de quemadura.',
            procedure: 'Limpieza suave y apósito de silicona no adherente.',
            materials: 'Solución fisiológica, apósito de silicona Mepitel One, crema hidratante',
            healingFrequency: 'Cada 72hs', healingFrequencyDays: 3,
            observations: 'Buena evolución. Continuar protección solar.',
            nextControl: '2026-05-01',
            painLevel: 3, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 6, woundWidth: 4, woundDepth: 0.1,
            tissueTypes: ['epitelizacion', 'granulacion'],
            edgeTypes: ['regular'],
            exudateAmount: 'escaso', exudateType: 'seroso', exudateColor: 'transparente',
            hasInfectionSigns: false, bodyTemperature: 36.6,
        ...
        evolutions: [
          {
            ...
            time: '15:30',
            professional: 'Dr. Carlos Rodríguez',
            description: 'Turno programado — control post-injerto.',
            procedure: 'Evaluación del injerto. Curación con apósito de silicona y vendaje.',
            materials: 'Solución fisiológica, apósito de silicona Mepitel, venda elástica, gasas estériles',
            healingFrequency: 'Cada 48hs', healingFrequencyDays: 2,
            observations: 'Mantener reposo relativo. Buena prendida del injerto.',
            nextControl: '2026-05-10',
            painLevel: 2, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 12, woundWidth: 8, woundDepth: 0.5,
            tissueTypes: ['epitelizacion', 'granulacion'],
          ...
          },
          {
            ...
            time: '15:30',
            professional: 'Dr. Carlos Rodríguez',
            description: 'Turno programado — curación post-quirúrgica.',
            procedure: 'Limpieza con SF. Apósito de silicona y vendaje compresivo.',
            materials: 'Solución fisiológica, apósito de silicona Mepitel, venda elástica',
            healingFrequency: 'Cada 48hs', healingFrequencyDays: 2,
            observations: 'Excelente integración del injerto.',
            nextControl: '2026-05-05',
            painLevel: 3, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 14, woundWidth: 9, woundDepth: 0.6,
            tissueTypes: ['epitelizacion', 'granulacion'],
            edgeTypes: ['regular'],
            exudateAmount: 'escaso', exudateType: 'seroso', exudateColor: 'transparente',
            hasInfectionSigns: false, bodyTemperature: 36.6,
          ...
          },
          {
            ...
            time: '15:30',
            professional: 'Dr. Carlos Rodríguez',
            description: 'Turno programado — control evolutivo.',
            procedure: 'Limpieza suave y curación con apósito húmedo Adaptic.',
            materials: 'Solución fisiológica, apósito húmedo Adaptic, apósito secundario, venda elástica',
            healingFrequency: 'Cada 48hs', healingFrequencyDays: 2,
            observations: 'Listo para próximo control quirúrgico.',
            nextControl: '2026-04-29',
            painLevel: 3, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 15, woundWidth: 10, woundDepth: 0.9,
            tissueTypes: ['granulacion'],
            edgeTypes: ['regular'],
            exudateAmount: 'escaso', exudateType: 'seroso', exudateColor: 'transparente',
            hasInfectionSigns: false, bodyTemperature: 36.6,
          ...
          },
          {
            ...
            painLevel: 3, odor: 'sin_olor', evolutionStatus: 'mejoria_progresiva',
            woundLength: 17, woundWidth: 11, woundDepth: 1.2,
            tissueTypes: ['granulacion'],
            edgeTypes: ['regular'],
            exudateAmount: 'escaso', exudateType: 'seroso', exudateColor: 'transparente',
            hasInfectionSigns: false, bodyTemperature: 36.6,
    ...
    cases: [
      {
        ...
        hasInfectionSigns: false, bodyTemperature: 36.5,
        healingFrequency: 'Semanal', healingFrequencyDays: 7,
        ...
        evolutions: [
          {
            ...
            painLevel: 1, odor: 'sin_olor', evolutionStatus: 'cicatrizada',
            woundLength: 0, woundWidth: 0, woundDepth: 0,
            tissueTypes: ['epitelizacion'],
            edgeTypes: ['regular'],
            exudateAmount: 'sin_exudado', exudateType: 'seroso', exudateColor: 'transparente',
            hasInfectionSigns: false, bodyTemperature: 36.4,
            healingDate: '2026-02-28', closedAt: '2026-02-28',
